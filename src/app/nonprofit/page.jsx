...
export default function Page() {
  return (<div style={{minHeight:"100vh",background:"#FAFAF8",fontFamily:"'Outfit',system-ui,sans-serif"}}>
    <div style={{background:"#fff",borderBottom:"1px solid #E8E4DD",padding:"28px 40px",display:"flex",alignItems:"center",gap:16}}>
      ...
      <div><div style={{fontSize:9,fontWeight:600,letterSpacing:6,color:"#2D8659",textTransform:"uppercase"}}>THE KOLLECTIVE HOSPITALITY GROUP</div>
      <h1 style={{fontSize:22,fontWeight:800,margin:0,color:"#1A1A18",fontFamily:"'Cormorant Garamond',serif"}}>{"Non-Profit"}</h1>
      <p style={{fontSize:11,color:"#A39E96",marginTop:2}}>{"Community · Foundation"}</p></div>
    </div>
