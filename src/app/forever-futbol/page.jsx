    ...
    <div style={{ minHeight: "100vh", background: "#060604", fontFamily: "'DM Sans',sans-serif", color: "#F0EDE6" }}>
      ...
      <div style={{ padding: "24px 32px" }}>
        ...
        <Section title="Sponsor Pipeline" icon="💎" count={`${sponsors.length} TOTAL`}>
          {sponsors.length === 0 ? <div style={{ background:"#0D0D0B", border:"1px solid #1a1a1a", borderRadius:8, padding:24, textAlign:"center", color:"#555", fontSize:12 }}>No sponsors in ff_sponsor_outreach yet</div> :
        ...
        <Section title="Brand Assets" icon="🎨" count={assets.length}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: 12 }}>
            {assets.slice(0,12).map((a,i) => (
              <div key={i} style={{ background:"#0D0D0B", border:"1px solid #1a1a1a", borderRadius:8, padding:12, textAlign:"center" }}>
