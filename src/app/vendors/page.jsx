    ...
    <div style={{ minHeight: "100vh", background: "#060604", fontFamily: "'DM Sans',sans-serif", color: "#F0EDE6" }}>
      ...
      <div style={{ padding: "24px 32px" }}>
        ...
        <Section title="Recent Submissions" icon="📝" count={submissions.length}>
          {submissions.length === 0 ? <div style={{ background:"#0D0D0B", border:"1px solid #1a1a1a", borderRadius:8, padding:24, textAlign:"center", color:"#555", fontSize:12 }}>No form submissions yet — forms are live on event sites</div> :
        ...
        <Section title="Vendor Form Configuration" icon="⚙️">
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(240px,1fr))", gap:12 }}>
            {["Soul Sessions","REMIX","Kulture","Cinco de Drinko","Underground King","Secret Society","WRST BHVR","Forever Futbol"].map(name => (
              <div key={name} style={{ background:"#0D0D0B", border:"1px solid #1a1a1a", borderRadius:8, padding:16 }}>
