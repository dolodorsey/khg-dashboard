    ...
    <div style={{ minHeight: "100vh", background: "#060604", fontFamily: "'DM Sans',sans-serif", color: "#F0EDE6" }}>
      ...
      <div style={{ padding: "24px 32px" }}>
        ...
        <Section title="Upcoming Events" icon="📅" count={upcoming.length}>
          {upcoming.length === 0 ? <div style={{ background:"#0D0D0B", border:"1px solid #1a1a1a", borderRadius:8, padding:24, textAlign:"center", color:"#555", fontSize:12 }}>No upcoming events listed</div> :
        ...
        <div style={{ background:"#0D0D0B", border:"1px solid #F59E0B33", borderRadius:8, padding:20, marginTop:16 }}>
