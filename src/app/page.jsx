...
const DASHBOARDS = [
  ...
  { key: "directory", label: "Directory / Links", icon: "🔗", desc: "All brand links, landing pages, QR codes, forms", color: "#00BCD4", ready: false },
  { key: "forever-futbol", label: "Forever Futbol", icon: "⚽", desc: "Museum ops, sponsors, volunteers, ticketing", color: "#2E8B57", ready: false },
  { key: "sole-exchange", label: "Sole Exchange", icon: "👟", desc: "Sneaker events, vendors, market operations", color: "#FF9800", ready: false },
  { key: "apps", label: "Apps", icon: "📲", desc: "Good Times, SOS, On Call — app metrics and ops", color: "#7C4DFF", ready: false },
